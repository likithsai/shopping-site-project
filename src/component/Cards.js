        ...
        <div>
            <div className="w-full transform overflow-hidden rounded-lg bg-white border">
                ...
                <div className="p-4 flex flex-col gap-2">
                    ...
                    <button onClick={props.onAddToCartClick} type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none w-full">Add to Cart</button>
                </div>
            </div>
        </div>
    );
