      ...
      {loading ? ( // Display loading skeleton when loading is true
        <div className="container mx-auto p-4 animate-pulse">
          <div className="sticky top-0">
            ...
            >
              <div className="w-64 h-48 bg-gray-300 rounded-md"></div>{" "}
              ...
              <div className="md:ml-8 mt-4 md:mt-0 w-full">
                ...
                <div className="h-4 w-1/2 bg-gray-300 rounded-full mb-2"></div>{" "}
                {/* Loading category skeleton */}
                <div className="flex items-center mt-4">
                  <div className="h-8 w-24 bg-gray-300 rounded-md mr-2"></div>{" "}
                  {/* Loading price skeleton */}
                  <div className="h-4 w-16 bg-gray-300 rounded-md"></div>{" "}
                  {/* Loading old price skeleton */}
                </div>
                <div className="mt-6 flex space-x-4">
                  <div className="h-12 w-24 bg-gray-300 rounded-md"></div>{" "}
                  {/* Loading Buy Now button skeleton */}
                  <div className="h-12 w-24 bg-gray-300 rounded-md"></div>{" "}
                  {/* Loading Add to Cart button skeleton */}
                </div>
              </div>
            </section>
          </div>
          <div className="mt-8">
            ...
            {/* Loading description title skeleton */}
            ...
            {/* Loading description skeleton */}
            <div className="h-4 w-4/5 bg-gray-300 rounded-md mb-4"></div>{" "}
            {/* Loading description skeleton */}
          </div>
        </div>
      ) : (
        item
          ...
          .map((itm) => (
            <div
              className="container mx-auto p-4 gap-8 flex flex-col"
              key={itm.id}
            >
              <section
                role="main"
              ...
              >
                ...
                <div className="md:ml-8 mt-4 md:mt-0">
                  <h1 className="text-3xl font-semibold mb-2 font-bold">
                    {itm.name}
                  </h1>
                  <p>{itm.description}</p>
                  <div className="flex items-center mt-4">
                    ...
                    <span className="text-lg text-gray-600 ml-2 line-through">
                      {itm.oldprice}
                    </span>
                  </div>
...
function mapDispatchToProps(dispatch) {
  return {
    addToCart: (item) =>
      dispatch({ type: appConstants.ADD_TO_CART, payload: item }),
  };
}
